...
const HomeScreen = () => {
	...
	const prepareChartData = () => {
		...
		// Highlight the selected month (Feb in the image)
							...
							{selectedBarIndex !== null && (
								<View
									style={[
										...
										{
											left:
												((width - 64) / chartData.labels.length) *
													(selectedBarIndex + 0.5) -
												40,
											top: 20,
										},
									]}
							...
							<BarChart
								...
								chartConfig={{
									...
									color: (opacity = 1, index = 0) => {
										// Make the selected month green, others light green
										if (index === chartData.selectedIndex) {
